extends Resource
class_name NpcWardenCombatEngageCell
...
var player_combat_profile := {
	...
	"crit_model": {
		"base_from_luck": 0.05,
		"fracture_or_trait_bonus": 0.20,
		"rupture_critical_bonus": 0.50
	},

	"action_economy": {
		"extra_attack_chance": 0.20
	}
}
...
var dense_hexblocks := [
	{
		...
		"data": PackedByteArray(
			...
			0x7E, 0x10, 0x02, 0xC0, 0xC1, 0xD0, 0x02, 0x01,
			0x7E, 0x10, 0x03, 0xC0, 0xA1, 0x50, 0x03, 0x01,
			0x7E, 0x10, 0x04, 0xC0, 0x1F, 0x3F, 0x04, 0x01
		)
	},
	{
