extends Node3D
class_name ColdVergeCryoRimRuntime
...
func _ready() -> void:
    ...
    if ambience_player == null:
        push_warning("ColdVerge: AmbiencePlayer missing.")
    else:
        GameState.extreme_ambience_player = ambience_player
        ambience_player.region_id = &"COLD_VERGE_CRYO_RIM"
    ...
    if ambience_controller_3d:
        ...
        ambience_controller_3d.region_id = &"COLD_VERGE_CRYO_RIM"
    ...
    DebugLog.log("ColdVergeRuntime", "READY", {
