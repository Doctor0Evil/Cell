extends Node3D
class_name RedSilenceSignalCradleRuntime
...
func _ready() -> void:
    ...
    if ambience_player == null:
        push_warning("RedSilence: AmbiencePlayer missing.")
    else:
        GameState.extreme_ambience_player = ambience_player
        ambience_player.region_id = &"RED_SILENCE_SIGNAL_CRADLE"
    ...
    if ambience_controller_3d:
        ...
        ambience_controller_3d.region_id = &"RED_SILENCE_SIGNAL_CRADLE"
    ...
    DebugLog.log("RedSilenceRuntime", "READY", {
